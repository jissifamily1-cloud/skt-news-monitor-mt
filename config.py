...
# 토픽 제외 — 제목에 필터 하나라도 있으면 발송 안 함 (야구/게임 기사 차단용)
BLOCK_KEYWORDS = [
    # 야구 일
    "야구", "KBO", "프로야구", "위즈", "시범경기", "퓨첔스", "스프링캠프",
    # 경기 용어
    "홈런", "타자", "투수", "포수", "불펜", "타선", "타점", "타율",
    "삼진", "호투", "등판", "끝내기", "완봉", "완투", "마운드", "이닝",
    "선발승", "구원슩", "도루",
    # 야구 타격/경기 용어 (2루타·냜타전 등은 위즈 없이도 출현)
    "1루타", "2루타", "3루타", "난타전", "재역전", "역전극",
    "실점", "연장전", "9회", "8회", "7회",  # 이닝 표기는 이미 있으��섨자형 보완
    # KBO 구단 별캭 (KT 위트 상대팀)
    "베어스", "자이앸츠", "이글스", "힙어로즈", "다이노스", "랜더스",
    "라이오늤", "타이거캨", "NC다이노스", "위즈파크",
    # e스포츠 (KT 롤스터 기사 차단)
    "LCK", "롤드컵", "리그오브레전드", "롤스터",
    "완파",   # 3대0 완파 등스포츠 완승 표현
    "젠지",   # Gen.G 이스포츠 팀
...
# (한국어 헤드뭼인은 조사 변형이 심해 Jaccard 비율보다 공유어 개수가 안정적)
...
# 기사 URL 도메인 → 매컴명 (네이버 API는 매체명을 안 주므로 도메인으로 추정)
